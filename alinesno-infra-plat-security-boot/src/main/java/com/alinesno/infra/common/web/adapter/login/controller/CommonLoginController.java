...
//                        new Menu("CodeOwasp", "plat/security/code/owasp/index", false,false,  "system/tenant/index", new Menu.Meta("功能分析", "tree", false, null)),
//                        new Menu("CodeOwasp", "plat/security/code/owasp/index", false,false,  "system/tenant/index", new Menu.Meta("威胁分析与响应", "tree", false, null))
//                ));
//
//        Menu serviceMenu = new Menu("Defense", "/defense", false, "noRedirect", "Layout", true, new Menu.Meta("安全防护", "log", false, null),
//                        List.of(
//                                new Menu("ServerDefense", "plat/security/defense/server/index", false,false, "monitor/operlog/index", new Menu.Meta("主机规则管理", "form", false, null)),
//                                new Menu("ServerDefense", "plat/security/defense/server/index", false,false, "monitor/operlog/index", new Menu.Meta("网页防篡改", "form", false, null)),
//                                new Menu("ServerDefense", "plat/security/defense/server/index", false,false, "monitor/operlog/index", new Menu.Meta("核心文件监控", "form", false, null)),
